...
开始界面默认选中 **经典模式**；也可切换为 **防守模式**，然后选择单人战役或创建房间。两种模式都支持 1～4 人，联机由房主在开房前选定，队友在大厅查看本局规则。

| 模式 | 阵地与敌军 | 胜利条件 |
| --- | --- | --- |
| 经典模式（默认） | 南北双方营地，敌方围墙可摧毁，敌军有驻守部队和持续增援 | 保住己方营地并摧毁敌军营地 |
...
单元测试覆盖两种模式的胜负、驻军与增援、双方围墙伤害、大地图导航、补给提示，以及冷却、受损、回血、复活、输入边界、方向移动和斜向限速。浏览器测试覆盖桌面方向移动/开火/暂停、手机横竖屏、多指操作，以及两个独立会话的真实 WebRTC 战场同步。
